/**
 * Crowd Runner - Input Handler
 *
 * Left/right drag or swipe steers the crowd between lanes.
 * Auto-runner: crowd advances forward automatically.
 */

import { onDrag, disableTouchActions } from '../../shared/input.js';

// How much a single drag pixel moves the lane offset
const STEER_SENSITIVITY = 0.008;

/**
 * Create input handler for Crowd Runner.
 *
